                                ...
                                <div className="p-l-25 p-r-30 p-lr-0-lg">
                                    <div className="wrap-slick3 flex-sb flex-w">
                                        ...
                                        <div className="slick3 gallery-lb">
                                            <div className="item-slick3" data-thumb="static/images/product-detail-01.jpg">
                                                <div className="wrap-pic-w pos-relative">
                                                    <img src="static/images/product-detail-01.jpg" alt="IMG-PRODUCT"/>

                                                    <a className="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="static/images/product-detail-01.jpg">
                                                        <i className="fa fa-expand"></i>
                                                    </a>
                                                </div>
                                            </div>

                                            <div className="item-slick3" data-thumb="static/images/product-detail-02.jpg">
                                                <div className="wrap-pic-w pos-relative">
                                                    <img src="static/images/product-detail-02.jpg" alt="IMG-PRODUCT"/>

                                                    <a className="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="static/images/product-detail-02.jpg">
                                                        <i className="fa fa-expand"></i>
                                                    </a>
                                                </div>
                                            </div>

                                            <div className="item-slick3" data-thumb="static/images/product-detail-03.jpg">
                                                <div className="wrap-pic-w pos-relative">
                                                    <img src="static/images/product-detail-03.jpg" alt="IMG-PRODUCT"/>

                                                    <a className="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="static/images/product-detail-03.jpg">
                                                        <i className="fa fa-expand"></i>
                                                    </a>
                                                </div>
                                            </div>
